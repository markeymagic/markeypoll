    ...
    return (
      <div className="App">
        <div className="container mx-auto md:w-3/5 px-3">
          <div className="text-grey-darkest md:text-lg italic mt-2 mb-3">Who is the coolest HLE engineer?</div>
...
class Candidate extends Component {
  ...
  render() {
    return (
      <button
        className={`focus:outline-none flex-1 py-2 px-3 mx-1 text-sm md:h-12 h-16 rounded bg-${this.props.color}-dark hover:bg-${this.props.color}-darker`}
        onClick={() =>
